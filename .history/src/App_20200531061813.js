...
export default class App extends Component {
  ...
  handleScroll = () => {
    ...
    if (
      ...
      this.setState(
        ...
        () => {
          this.setState(
            apiUrl: this.movie_db_category[this.state.currentCategory]
          )
          
        }
      );
      // console.log(this.movie_db_category[this.state.currentCategory]);
      // this.setState({
  ...
  componentDidMount() {
    this.setState({
      apiUrl: this.movie_db_category["popular"],
    });
    setTimeout(() => {
